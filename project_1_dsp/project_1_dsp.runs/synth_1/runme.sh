...
HD_PWD='C:/Digital 2025/projects/PROJECT 1 DSP/project_1_dsp/project_1_dsp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_DSP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_DSP.tcl
